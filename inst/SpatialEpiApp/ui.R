if(!require(tidyverse)) install.packages("tidyverse",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(shiny)) install.packages("shiny",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(shinyjs)) install.packages("shinyjs",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(htmlwidgets)) install.packages("htmlwidgets",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(leaflet)) install.packages("leaflet",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(dygraphs)) install.packages("dygraphs",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(markdown)) install.packages("markdown",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(rmarkdown)) install.packages("rmarkdown",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(knitr)) install.packages("knitr",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(fmesher)) install.packages("fmesher",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(INLA)) install.packages("INLA",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(SpatialEpi)) install.packages("SpatialEpi",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(terra)) install.packages("terra",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(spdep)) install.packages("spdep",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(dplyr)) install.packages("dplyr",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(xts)) install.packages("xts",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(broom)) install.packages("broom",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(ggplot2)) install.packages("ggplot2",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(RColorBrewer)) install.packages("RColorBrewer",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(sf)) install.packages("sf",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(mapproj)) install.packages("mapproj",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(raster)) install.packages("raster",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(latex2exp)) install.packages("latex2exp",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(latexpdf)) install.packages("latexpdf",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(tinytex)) install.packages("tinytex",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(stats)) install.packages("stats",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(pandoc)) install.packages("pandoc",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
if(!require(lubridate)) install.packages("lubridate",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
#if(!require(DT)) install.packages("DT",  repos = "https://inla.r-inla-download.org/R/stable", dep = TRUE)
...
library(SpatialEpi)
library(terra)
#library(maptools) deprecated use sf or terra
library(spdep)
library(dplyr)
library(xts)
library(broom)
...
library(sf)   
#library(rgeos) deprecated use sf or terra
library(mapproj)
library(raster)
#library(rgdal) deprecated use sf or terra
library(latex2exp)
library(latexpdf)
library(tinytex)
library(stats)
...
conditionalPanel(condition = "input.selectstage == 'stageuploaddata'",
  ...
  fluidRow(
    ...
    column(4, style = "height:800px;  margin:10px; border-style: solid;border-color:gray",
           ...
           fileInput(inputId = "filedata", label = "", accept = c(".csv")),
    ...
    column(3, style = "height:800px;  margin:10px; border-style: solid;border-color:gray",
           ...
           dateRangeInput("daterange", "Date range", start="1985-01-01", end="1988-01-01", format = "yyyy-mm-dd", separator = " to "),
           hr(),
           conditionalPanel(condition = "input.typecovariates == 'individual'",
